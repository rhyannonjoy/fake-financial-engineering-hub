...
function initSearch() {
  ...
  request.open('GET', '/fake-financial-engineering-hub/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/fake-financial-engineering-hub/assets/css/just-the-docs-' + theme + '.css');
}
